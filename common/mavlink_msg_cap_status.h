...
typedef struct MAVLINK_PACKED __mavlink_cap_status_t
{
 ...
 uint8_t airspeed_cal; /*< Airspeed sensor calibration status*/
 uint8_t home_init; /*< Home location status*/
 uint8_t land_detected; /*< Land detection status*/
} mavlink_cap_status_t;

#define MAVLINK_MSG_ID_CAP_STATUS_LEN 4
#define MAVLINK_MSG_ID_CAP_STATUS_MIN_LEN 4
#define MAVLINK_MSG_ID_180_LEN 4
#define MAVLINK_MSG_ID_180_MIN_LEN 4

#define MAVLINK_MSG_ID_CAP_STATUS_CRC 255
...
#define MAVLINK_MESSAGE_INFO_CAP_STATUS { \
	...
	{  { "parachute_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_cap_status_t, parachute_status) }, \
         ...
         { "land_detected", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_cap_status_t, land_detected) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAP_STATUS { \
 ...
 * @param airspeed_cal Airspeed sensor calibration status
 * @param home_init Home location status
 * @param land_detected Land detection status
...
static inline uint16_t mavlink_msg_cap_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t parachute_status, uint8_t airspeed_cal, uint8_t home_init, uint8_t land_detected)
{
	...
	_mav_put_uint8_t(buf, 3, land_detected);
	...
	packet.land_detected = land_detected;
...
{
	return mavlink_msg_cap_status_pack(system_id, component_id, msg, cap_status->parachute_status, cap_status->airspeed_cal, cap_status->home_init, cap_status->land_detected);
}
...
{
	return mavlink_msg_cap_status_pack_chan(system_id, component_id, chan, msg, cap_status->parachute_status, cap_status->airspeed_cal, cap_status->home_init, cap_status->land_detected);
}
...
static inline void mavlink_msg_cap_status_send(mavlink_channel_t chan, uint8_t parachute_status, uint8_t airspeed_cal, uint8_t home_init, uint8_t land_detected)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_CAP_STATUS_LEN];
	_mav_put_uint8_t(buf, 0, parachute_status);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_cap_status_send(chan, cap_status->parachute_status, cap_status->airspeed_cal, cap_status->home_init, cap_status->land_detected);
#else
 ...
 */
static inline void mavlink_msg_cap_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t parachute_status, uint8_t airspeed_cal, uint8_t home_init, uint8_t land_detected)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field land_detected from cap_status message
 *
 * @return Land detection status
 */
static inline uint8_t mavlink_msg_cap_status_get_land_detected(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_cap_status_decode(const mavlink_message_t* msg, mavlink_cap_status_t* cap_status)
{
	...
	cap_status->land_detected = mavlink_msg_cap_status_get_land_detected(msg);
#else
