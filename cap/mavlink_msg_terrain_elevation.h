...
typedef struct __mavlink_terrain_elevation_t {
 float terrain_elevation; /*< Terrain elevation*/
 uint8_t target_system; /*< System which should execute the command*/
}) mavlink_terrain_elevation_t;

#define MAVLINK_MSG_ID_TERRAIN_ELEVATION_LEN 5
#define MAVLINK_MSG_ID_TERRAIN_ELEVATION_MIN_LEN 5
#define MAVLINK_MSG_ID_184_LEN 5
#define MAVLINK_MSG_ID_184_MIN_LEN 5

#define MAVLINK_MSG_ID_TERRAIN_ELEVATION_CRC 239
#define MAVLINK_MSG_ID_184_CRC 239
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_ELEVATION { \
    ...
    "TERRAIN_ELEVATION", \
    2, \
    {  { "terrain_elevation", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_terrain_elevation_t, terrain_elevation) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_terrain_elevation_t, target_system) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_ELEVATION { \
...
static inline uint16_t mavlink_msg_terrain_elevation_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, float terrain_elevation)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TERRAIN_ELEVATION_LEN];
    _mav_put_float(buf, 0, terrain_elevation);
...
{
    return mavlink_msg_terrain_elevation_pack(system_id, component_id, msg, terrain_elevation->target_system, terrain_elevation->terrain_elevation);
}
...
{
    return mavlink_msg_terrain_elevation_pack_chan(system_id, component_id, chan, msg, terrain_elevation->target_system, terrain_elevation->terrain_elevation);
}
...
static inline void mavlink_msg_terrain_elevation_send(mavlink_channel_t chan, uint8_t target_system, float terrain_elevation)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TERRAIN_ELEVATION_LEN];
    _mav_put_float(buf, 0, terrain_elevation);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_terrain_elevation_send(chan, terrain_elevation->target_system, terrain_elevation->terrain_elevation);
#else
 ...
 */
static inline void mavlink_msg_terrain_elevation_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, float terrain_elevation)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float mavlink_msg_terrain_elevation_get_terrain_elevation(const mavlink_message_t* msg)
{
