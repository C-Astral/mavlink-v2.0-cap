...
#define MAVLINK_MSG_ID_MISSION_HASH_LEN 5
#define MAVLINK_MSG_ID_MISSION_HASH_MIN_LEN 5
#define MAVLINK_MSG_ID_183_LEN 5
#define MAVLINK_MSG_ID_183_MIN_LEN 5

#define MAVLINK_MSG_ID_MISSION_HASH_CRC 102
#define MAVLINK_MSG_ID_183_CRC 102
...
#define MAVLINK_MESSAGE_INFO_MISSION_HASH { \
    ...
    {  { "hash", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_mission_hash_t, hash) }, \
         { "request", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mission_hash_t, request) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_HASH { \
...
{
    return mavlink_msg_mission_hash_pack(system_id, component_id, msg, mission_hash->request, mission_hash->hash);
}
...
{
    return mavlink_msg_mission_hash_pack_chan(system_id, component_id, chan, msg, mission_hash->request, mission_hash->hash);
}
...
static inline void mavlink_msg_mission_hash_send(mavlink_channel_t chan, uint8_t request, uint32_t hash)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MISSION_HASH_LEN];
    _mav_put_uint32_t(buf, 0, hash);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mission_hash_send(chan, mission_hash->request, mission_hash->hash);
#else
 ...
 */
static inline void mavlink_msg_mission_hash_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t request, uint32_t hash)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
