...
#define MAVLINK_MSG_ID_SERIAL_PASSTHROUGH_ACK_LEN 4
#define MAVLINK_MSG_ID_SERIAL_PASSTHROUGH_ACK_MIN_LEN 4
#define MAVLINK_MSG_ID_182_LEN 4
#define MAVLINK_MSG_ID_182_MIN_LEN 4

#define MAVLINK_MSG_ID_SERIAL_PASSTHROUGH_ACK_CRC 50
#define MAVLINK_MSG_ID_182_CRC 50
...
#define MAVLINK_MESSAGE_INFO_SERIAL_PASSTHROUGH_ACK { \
    ...
    4, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_serial_passthrough_ack_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_serial_passthrough_ack_t, target_component) }, \
         { "number", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_serial_passthrough_ack_t, number) }, \
         { "error", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_serial_passthrough_ack_t, error) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SERIAL_PASSTHROUGH_ACK { \
...
static inline uint16_t mavlink_msg_serial_passthrough_ack_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t number, uint8_t error)
{
...
{
    return mavlink_msg_serial_passthrough_ack_pack(system_id, component_id, msg, serial_passthrough_ack->target_system, serial_passthrough_ack->target_component, serial_passthrough_ack->number, serial_passthrough_ack->error);
}
...
{
    return mavlink_msg_serial_passthrough_ack_pack_chan(system_id, component_id, chan, msg, serial_passthrough_ack->target_system, serial_passthrough_ack->target_component, serial_passthrough_ack->number, serial_passthrough_ack->error);
}
...
static inline void mavlink_msg_serial_passthrough_ack_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t number, uint8_t error)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SERIAL_PASSTHROUGH_ACK_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_serial_passthrough_ack_send(chan, serial_passthrough_ack->target_system, serial_passthrough_ack->target_component, serial_passthrough_ack->number, serial_passthrough_ack->error);
#else
 ...
 */
static inline void mavlink_msg_serial_passthrough_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t number, uint8_t error)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_system from serial_passthrough_ack message
 *
 * @return  System which should execute the command
 */
static inline uint8_t mavlink_msg_serial_passthrough_ack_get_target_system(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  0);
}

/**
 * @brief Get field target_component from serial_passthrough_ack message
 *
 * @return  Component which should execute the command, 0 for all components
 */
static inline uint8_t mavlink_msg_serial_passthrough_ack_get_target_component(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    serial_passthrough_ack->target_system = mavlink_msg_serial_passthrough_ack_get_target_system(msg);
    serial_passthrough_ack->target_component = mavlink_msg_serial_passthrough_ack_get_target_component(msg);
