...
typedef struct __mavlink_autopilot_version_t {
 ...
 uint64_t uid; /*<  UID if provided by hardware (bottom 64-bits)*/
 ...
 uint32_t uid_high; /*<  UID if provided by hardware (top 32-bits)*/
...
#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_LEN 64
#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_MIN_LEN 64
#define MAVLINK_MSG_ID_148_LEN 64
#define MAVLINK_MSG_ID_148_MIN_LEN 64

#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_CRC 169
#define MAVLINK_MSG_ID_148_CRC 169
...
#define MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION { \
    ...
    {  { "capabilities", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_autopilot_version_t, capabilities) }, \
         ...
         { "flight_custom_version", NULL, MAVLINK_TYPE_UINT8_T, 8, 40, offsetof(mavlink_autopilot_version_t, flight_custom_version) }, \
         { "middleware_custom_version", NULL, MAVLINK_TYPE_UINT8_T, 8, 48, offsetof(mavlink_autopilot_version_t, middleware_custom_version) }, \
         { "os_custom_version", NULL, MAVLINK_TYPE_UINT8_T, 8, 56, offsetof(mavlink_autopilot_version_t, os_custom_version) }, \
         { "vendor_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 36, offsetof(mavlink_autopilot_version_t, vendor_id) }, \
         { "product_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 38, offsetof(mavlink_autopilot_version_t, product_id) }, \
         { "uid", NULL, MAVLINK_TYPE_UINT64_T, 0, 8, offsetof(mavlink_autopilot_version_t, uid) }, \
         { "uid_high", NULL, MAVLINK_TYPE_UINT32_T, 0, 32, offsetof(mavlink_autopilot_version_t, uid_high) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION { \
 ...
 * @param uid  UID if provided by hardware (bottom 64-bits)
 * @param uid_high  UID if provided by hardware (top 32-bits)
                               ...
                               uint64_t capabilities, uint32_t flight_sw_version, uint32_t middleware_sw_version, uint32_t os_sw_version, uint32_t board_version, const uint8_t *flight_custom_version, const uint8_t *middleware_custom_version, const uint8_t *os_custom_version, uint16_t vendor_id, uint16_t product_id, uint64_t uid, uint32_t uid_high)
{
    ...
    _mav_put_uint32_t(buf, 32, uid_high);
    _mav_put_uint16_t(buf, 36, vendor_id);
    _mav_put_uint16_t(buf, 38, product_id);
    _mav_put_uint8_t_array(buf, 40, flight_custom_version, 8);
    _mav_put_uint8_t_array(buf, 48, middleware_custom_version, 8);
    _mav_put_uint8_t_array(buf, 56, os_custom_version, 8);
...
{
    return _MAV_RETURN_uint8_t_array(msg, flight_custom_version, 8,  40);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, middleware_custom_version, 8,  48);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, os_custom_version, 8,  56);
}
 ...
 *
 * @return  UID if provided by hardware (bottom 64-bits)
 */
...
/**
 * @brief Get field uid_high from autopilot_version message
 *
 * @return  UID if provided by hardware (top 32-bits)
 */
static inline uint32_t mavlink_msg_autopilot_version_get_uid_high(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_autopilot_version_decode(const mavlink_message_t* msg, mavlink_autopilot_version_t* autopilot_version)
{
    ...
    autopilot_version->uid_high = mavlink_msg_autopilot_version_get_uid_high(msg);
