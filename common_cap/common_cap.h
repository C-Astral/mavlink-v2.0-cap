/** @file
 *  @brief MAVLink comm protocol generated from common_cap.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_COMMON_CAP_H
#define MAVLINK_COMMON_CAP_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_COMMON_CAP.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
