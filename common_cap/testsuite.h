...
static void mavlink_test_mission_item(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_mission_item_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,963498920,241.0,269.0,297.0,19523,19627,149,216,27,94,161,228
    };
	mavlink_mission_item_t packet1, packet2;
        ...
        packet1.pattern_type = packet_in.pattern_type;
	...
	mavlink_msg_mission_item_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mission_item_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.seq , packet1.frame , packet1.command , packet1.current , packet1.autocontinue , packet1.param1 , packet1.param2 , packet1.param3 , packet1.param4 , packet1.x , packet1.y , packet1.z , packet1.flags , packet1.pattern_type , packet1.length , packet1.bearing , packet1.mission_type );
	mavlink_msg_mission_item_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mission_item_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.seq , packet1.frame , packet1.command , packet1.current , packet1.autocontinue , packet1.param1 , packet1.param2 , packet1.param3 , packet1.param4 , packet1.x , packet1.y , packet1.z , packet1.flags , packet1.pattern_type , packet1.length , packet1.bearing , packet1.mission_type );
	mavlink_msg_mission_item_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mission_item_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mission_item_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.seq , packet1.frame , packet1.command , packet1.current , packet1.autocontinue , packet1.param1 , packet1.param2 , packet1.param3 , packet1.param4 , packet1.x , packet1.y , packet1.z , packet1.flags , packet1.pattern_type , packet1.length , packet1.bearing , packet1.mission_type );
	mavlink_msg_mission_item_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_autopilot_version(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_autopilot_version_t packet_in = {
		93372036854775807ULL,93372036854776311ULL,963498296,963498504,963498712,963498920,963499128,19107,19211,{ 125, 126, 127, 128, 129, 130, 131, 132 },{ 149, 150, 151, 152, 153, 154, 155, 156 },{ 173, 174, 175, 176, 177, 178, 179, 180 }
    };
	mavlink_autopilot_version_t packet1, packet2;
        ...
        packet1.uid_high = packet_in.uid_high;
...
static void mavlink_test_cap_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_cap_status_t packet_in = {
		123.0,179.0,235.0,963498712,213.0,963499128,269.0,297.0,325.0,19731,19835,19939,20043,20147,20251,20355
    };
	mavlink_cap_status_t packet1, packet2;
        ...
        packet1.flightplan_hash = packet_in.flightplan_hash;
        packet1.baro_altitude = packet_in.baro_altitude;
        packet1.eph = packet_in.eph;
        packet1.epv = packet_in.epv;
        ...
        packet1.flightplan_items_count = packet_in.flightplan_items_count;
...
static void mavlink_test_v2_extension(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_v2_extension_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.payload, packet_in.payload, sizeof(uint8_t)*10);
	...
	mavlink_msg_v2_extension_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_v2_extension_pack(system_id, component_id, &msg , packet1.payload );
	mavlink_msg_v2_extension_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_v2_extension_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.payload );
	mavlink_msg_v2_extension_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_v2_extension_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_v2_extension_send(MAVLINK_COMM_1 , packet1.payload );
	mavlink_msg_v2_extension_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
