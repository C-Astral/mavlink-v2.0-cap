/** @file
 *    @brief MAVLink comm protocol testsuite generated from common_cap.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef COMMON_CAP_TESTSUITE_H
#define COMMON_CAP_TESTSUITE_H
...
static void mavlink_test_common_cap(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_common_cap(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_cap_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_cap_status_t packet_in = {
        123.0,179.0,235.0,963498712,213.0,18899,19003,19107,19211,19315,19419
    };
    mavlink_cap_status_t packet1, packet2;
        ...
        packet1.speed_override_value = packet_in.speed_override_value;
        ...
        packet1.battery_remaining = packet_in.battery_remaining;
        packet1.altitude_override_value = packet_in.altitude_override_value;
    ...
    mavlink_msg_cap_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_status_pack(system_id, component_id, &msg , packet1.number_of_photos , packet1.air_time , packet1.battery_voltage , packet1.battery_current , packet1.battery_remaining , packet1.global_status , packet1.home_latitude , packet1.home_longitude , packet1.home_altitude , packet1.altitude_override_value , packet1.speed_override_value );
    mavlink_msg_cap_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.number_of_photos , packet1.air_time , packet1.battery_voltage , packet1.battery_current , packet1.battery_remaining , packet1.global_status , packet1.home_latitude , packet1.home_longitude , packet1.home_altitude , packet1.altitude_override_value , packet1.speed_override_value );
    mavlink_msg_cap_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cap_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_status_send(MAVLINK_COMM_1 , packet1.number_of_photos , packet1.air_time , packet1.battery_voltage , packet1.battery_current , packet1.battery_remaining , packet1.global_status , packet1.home_latitude , packet1.home_longitude , packet1.home_altitude , packet1.altitude_override_value , packet1.speed_override_value );
    mavlink_msg_cap_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_serial_passthrough_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_serial_passthrough_ack_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_passthrough_ack_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.number , packet1.error );
    mavlink_msg_serial_passthrough_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_passthrough_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.number , packet1.error );
    mavlink_msg_serial_passthrough_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_serial_passthrough_ack_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_passthrough_ack_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.number , packet1.error );
    mavlink_msg_serial_passthrough_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_mission_hash(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_mission_hash_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mission_hash_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.request , packet1.hash );
    mavlink_msg_mission_hash_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mission_hash_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.request , packet1.hash );
    mavlink_msg_mission_hash_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mission_hash_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mission_hash_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.request , packet1.hash );
    mavlink_msg_mission_hash_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_terrain_elevation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_terrain_elevation_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_terrain_elevation_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.terrain_elevation );
    mavlink_msg_terrain_elevation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_terrain_elevation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.terrain_elevation );
    mavlink_msg_terrain_elevation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_terrain_elevation_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_terrain_elevation_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.terrain_elevation );
    mavlink_msg_terrain_elevation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_cap_params(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CAP_PARAMS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_cap_params_t packet_in = {
        963497464,963497672,73.0,101.0,129.0,963498504,963498712,213.0,241.0,963499336,963499544,325.0,353.0,161,228,39
    };
    mavlink_cap_params_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.NAV_DLL_ACT = packet_in.NAV_DLL_ACT;
        packet1.COM_DL_LOSS_T = packet_in.COM_DL_LOSS_T;
        packet1.COM_TER_FLS_AGL = packet_in.COM_TER_FLS_AGL;
        packet1.COM_TER_FLS_CLMB = packet_in.COM_TER_FLS_CLMB;
        packet1.COM_TER_CRIT_AGL = packet_in.COM_TER_CRIT_AGL;
        packet1.COM_TER_FLS_ENBL = packet_in.COM_TER_FLS_ENBL;
        packet1.COM_LOW_BAT_ACT = packet_in.COM_LOW_BAT_ACT;
        packet1.BAT_LOW_THR = packet_in.BAT_LOW_THR;
        packet1.BAT_CRIT_THR = packet_in.BAT_CRIT_THR;
        packet1.PARAM_1_UINT32 = packet_in.PARAM_1_UINT32;
        packet1.PARAM_2_UINT32 = packet_in.PARAM_2_UINT32;
        packet1.PARAM_1_FLOAT = packet_in.PARAM_1_FLOAT;
        packet1.PARAM_2_FLOAT = packet_in.PARAM_2_FLOAT;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CAP_PARAMS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CAP_PARAMS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_params_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_cap_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_params_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.Set , packet1.NAV_DLL_ACT , packet1.COM_DL_LOSS_T , packet1.COM_TER_FLS_AGL , packet1.COM_TER_FLS_CLMB , packet1.COM_TER_CRIT_AGL , packet1.COM_TER_FLS_ENBL , packet1.COM_LOW_BAT_ACT , packet1.BAT_LOW_THR , packet1.BAT_CRIT_THR , packet1.PARAM_1_UINT32 , packet1.PARAM_2_UINT32 , packet1.PARAM_1_FLOAT , packet1.PARAM_2_FLOAT );
    mavlink_msg_cap_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_params_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.Set , packet1.NAV_DLL_ACT , packet1.COM_DL_LOSS_T , packet1.COM_TER_FLS_AGL , packet1.COM_TER_FLS_CLMB , packet1.COM_TER_CRIT_AGL , packet1.COM_TER_FLS_ENBL , packet1.COM_LOW_BAT_ACT , packet1.BAT_LOW_THR , packet1.BAT_CRIT_THR , packet1.PARAM_1_UINT32 , packet1.PARAM_2_UINT32 , packet1.PARAM_1_FLOAT , packet1.PARAM_2_FLOAT );
    mavlink_msg_cap_params_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cap_params_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cap_params_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.Set , packet1.NAV_DLL_ACT , packet1.COM_DL_LOSS_T , packet1.COM_TER_FLS_AGL , packet1.COM_TER_FLS_CLMB , packet1.COM_TER_CRIT_AGL , packet1.COM_TER_FLS_ENBL , packet1.COM_LOW_BAT_ACT , packet1.BAT_LOW_THR , packet1.BAT_CRIT_THR , packet1.PARAM_1_UINT32 , packet1.PARAM_2_UINT32 , packet1.PARAM_1_FLOAT , packet1.PARAM_2_FLOAT );
    mavlink_msg_cap_params_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common_cap(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_cap_params(system_id, component_id, last_msg);
